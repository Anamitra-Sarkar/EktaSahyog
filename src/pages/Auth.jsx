...
const Auth = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = `https://ektasahyog.onrender.com${endpoint}`;
                    ...
                    <div className="w-full bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row ring-1 ring-white/10 opacity-95 hover:opacity-100 transition-opacity">
                        ...
                        <div className="w-full md:w-7/12 p-8 md:p-12 bg-white relative">
                            ...
                            <div className="space-y-4 text-center">
                                  <button type="button" onClick={() => window.location.href = "https://ektasahyog.onrender.com/auth/google"} className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700">
