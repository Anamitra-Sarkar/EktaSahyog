...
const Projects = () => {
    ...
    const fetchProjects = async () => {
        try {
            const res = await fetch('https://ektasahyog.onrender.com/projects');
    ...
    const handleJoin = async (project) => {
        ...
        try {
            const res = await fetch(`https://ektasahyog.onrender.com/projects/${project._id}/join`, {
                method: 'PATCH',
    ...
    const handleLeave = async (project) => {
        ...
        try {
            const res = await fetch(`https://ektasahyog.onrender.com/projects/${project._id}/leave`, {
                method: 'PATCH',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ userId: user._id })
            });
    ...
    const handleDonate = async (project, amount) => {
        ...
        try {
            const res = await fetch('https://ektasahyog.onrender.com/projects/donate', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
